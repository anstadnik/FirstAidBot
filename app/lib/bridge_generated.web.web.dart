...
class FaApiWasmModule implements WasmModule {
  ...
  external dynamic /* Object */ wire_get_dynamic();

  external dynamic /* void */ wire_get_cached(NativePortType port_);

  external dynamic /* Object */ wire_get_state(
      Object data, List<String> ctx, String lang);
...
class FaApiWire extends FlutterRustBridgeWasmWireBase<FaApiWasmModule> {
  ...
  dynamic /* Object */ wire_get_dynamic() => wasmModule.wire_get_dynamic();

  void wire_get_cached(NativePortType port_) =>
      wasmModule.wire_get_cached(port_);

  dynamic /* Object */ wire_get_state(
          Object data, List<String> ctx, String lang) =>
      wasmModule.wire_get_state(data, ctx, lang);
